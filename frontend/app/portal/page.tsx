...
type BillingInvoice = { id: string; invoice_number: string; quote_number: string; status: string; currency_code: string; amount_due: string; amount_paid: string; shipping_amount: string; applied_credit_total: string; outstanding_balance: string; due_at: string | null; issued_at: string; credit_notes: Array<{ id: string; amount: string; status: string; reason: string; created_at: string }> };
